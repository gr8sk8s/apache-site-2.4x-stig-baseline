...
is built for enterprise-wide user management, like LDAP and Active Directory.'
  desc 'check', "Interview the System Administrator (SA) about the role of the Apache web
server.
...
accomplished outside of the Apache web server, this is a finding."
  desc 'fix', 'Reconfigure any hosted applications on the Apache web server to perform
